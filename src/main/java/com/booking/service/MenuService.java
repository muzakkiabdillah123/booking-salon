...
public class MenuService {
    ...
    public static void mainMenu() {
        ...
        String[] subMenuArr = { "Tampilkan Recent Reservation", "Tampilkan Customer", "Tampilkan Employee",
                "Tampilkan History Reservation + Total Keuntungan", "Back to main menu" };
        ...
        do {
            ...
            switch (optionMainMenu) {
                case 1:
                    do {
                        PrintService.printMenu("Tampilkan Data", subMenuArr);
